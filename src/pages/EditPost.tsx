...
const EditPost = () => {
  ...
  const { register, handleSubmit, formState: { errors, isSubmitting }, setValue, watch, reset } = useForm<PostFormData>({
  ...
  useEffect(() => {
    if (post) {
      ...
      if (existingImage) {
        ...
        if (existingImage.startsWith('data:') || existingImage.startsWith('http') || existingImage.startsWith('https')) {
          setImagePreview(existingImage);
        } else if (existingImage) {
          // If it's stored as base64 without data: prefix, add it
          setImagePreview(existingImage);
        }
      } else {
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#1a0b2e] via-[#2d1b4e] to-[#1a0b2e] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 pt-24 pb-8 relative z-10">
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-16 text-center">
            <p className="text-white/80 font-poppins mb-4">Post not found</p>
            <Button
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1a0b2e] via-[#2d1b4e] to-[#1a0b2e] relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl px-4 pt-24 pb-8 relative z-10">
        ...
        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-8 shadow-2xl">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-white mb-2 font-urbanist">Edit Post</h1>
            <p className="text-white/80 text-sm md:text-base font-poppins">Update your post content</p>
          </div>
